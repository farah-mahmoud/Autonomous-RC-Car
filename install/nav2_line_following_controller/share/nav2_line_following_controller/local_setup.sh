...
: ${AMENT_CURRENT_PREFIX:="/home/farah/farah/GP_Repo/Autonomous-RC-Car/install/nav2_line_following_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_line_following_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_line_following_controller/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_line_following_controller/environment/path.sh"
